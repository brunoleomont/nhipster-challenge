...
export class Config {
    debugLogging = 'debug';
    'server.port' = '8081';
    'jhipster.clientApp.name' = 'crudApp';
    ...
    'jhipster.mail.from' = 'crudApp@localhost';
    'jhipster.swagger.default-include-pattern' = '/api/.*';
    'jhipster.swagger.title' = 'crudApp API';
    'jhipster.swagger.description' = 'crudApp API documentation';
    ...
    'eureka.instance.appname' = 'crudApp';
    'eureka.instance.instanceId' = 'crudApp:${random.value}';
