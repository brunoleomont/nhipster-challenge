...
export const Professional = (props: IProfessionalProps) => {
  ...
  const { professionalList, match, loading, totalItems } = props;
  return (
    <div>
                ...
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td className="text-right">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button
                        tag={Link}
                        to={`${match.url}/${professional.id}/edit?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        color="primary"
                        size="sm"
                      ...
                      <Button
                        tag={Link}
                        to={`${match.url}/${professional.id}/delete?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        color="danger"
                        size="sm"
...
const mapStateToProps = ({ professional }: IRootState) => ({
  professionalList: professional.entities,
  loading: professional.loading,
  totalItems: professional.totalItems,
});
